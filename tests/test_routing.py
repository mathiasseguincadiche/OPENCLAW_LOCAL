...
def test_cloud_requests_are_always_rejected_in_v2() -> None:
...
def test_cloud_preconditions_cannot_reenable_online_model_routes() -> None:
    with pytest.raises(PermissionError, match="aucune escalade"):
        select_route(
            "expert-recherche",
            request_cloud=True,
            cloud_enabled=True,
